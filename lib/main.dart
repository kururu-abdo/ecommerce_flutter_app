...
void main()async {
 ...
 if (Platform.isIOS) {
      await Firebase.initializeApp();
          ...
          await Firebase.initializeApp(
            options: const FirebaseOptions(apiKey: 'AIzaSyDBn_vB2ikkx_8C-9CQGUsv9WVw1Xj5P5A', 
            appId: '1:1090752258256:android:c0b2498670eef9c51dfed5',
             messagingSenderId:
              '1090752258256',
               projectId: 'online-shop-d2eca')
          );
